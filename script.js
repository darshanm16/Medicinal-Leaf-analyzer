...
const medicinalLeaves = [
  {
    ...
    dosage: "Fresh leaves: 2-4 leaves daily; Tea: 1-2 cups daily",
  ...
  },
  {
    ...
    isMedicinal: true,
    confidence: 91.2,
    properties: ["Antibacterial", "Antifungal", "Antiviral", "Blood purifier"],
    uses: [
    ...
    dosage: "Leaf powder: 1-2g twice daily; Fresh leaves: 4-5 leaves daily",
    precautions: "Avoid excessive consumption, not for infants",
    features: {
      shape: "Pinnate compound leaves",
      color: "Dark green",
      texture: "Smooth, leathery",
      aroma: "Bitter, pungent",
    },
  },
  {
    name: "Aloe Vera",
    ...
    uses: ["Skin care", "Burn treatment", "Digestive health", "Hair care"],
    dosage: "Gel: Apply topically as needed; Juice: 30-50ml daily",
    precautions: "May cause allergic reactions, avoid latex during pregnancy",
    features: {
      shape: "Thick, fleshy, lance-shaped",
      color: "Green with white spots",
      texture: "Succulent, gel-filled",
      aroma: "Mild, fresh",
    },
  },
];

const nonMedicinalLeaves = [
  {
    name: "Maple Leaf",
    ...
    suggestions: [
      ...
      "Neem - For skin conditions and blood purification",
  ...
  },
  {
    ...
    suggestions: [
      ...
      "Moringa - For nutritional supplementation",
      "Ashwagandha - For stress and vitality",
      "Brahmi - For cognitive enhancement",
    ],
  },
];
